...
const buttonVariants = tv({
	...
	compoundVariants: [
		{
			variant: "accent",
			class: "intent:filter-darker [--nou-btn-bg:var(--color-primary)]",
		},
		{
			variant: "accent",
			tone: "tertiary",
			class:
				"intent:filter-darker bg-tertiary text-on-tertiary outline-tertiary [--nou-btn-bg:var(--color-tertiary)]",
		},
		{
			variant: "accent",
			tone: "destructive",
		...
		},
		{
			...
			tone: "primary",
			class:
				"intent:filter-darker bg-primary-container text-on-primary-container [--nou-btn-bg:var(--color-primary-container)]",
		},
		{
			variant: "tonal",
			tone: "tertiary",
			class:
				"intent:filter-darker bg-tertiary-container text-on-tertiary-container [--nou-btn-bg:var(--color-tertiary-container)]",
		},
		{
			variant: "tonal",
			tone: "destructive",
			class:
				"bg-error/5 text-error [--nou-btn-bg:var(--color-error/0.05)] hover:bg-error/8 focus:bg-error/12",
		},
		{
			variant: "tonal",
			tone: "success",
		...
		},
		{
			...
			tone: "primary",
			class:
				"text-primary outline-primary [--nou-btn-bg:var(--color-surface)] hover:bg-primary/5 focus:bg-primary/8",
		},
		{
			variant: "ghost",
			tone: "destructive",
			class: "text-error [--nou-btn-bg:var(--color-error/0.05)] hover:bg-error/5 focus:bg-error/8",
		},
		{
			variant: "link",
	...
	return (
		...
		>
			...
			<Show when={local.pending}>
				<div class="absolute inset-0 isolate flex cursor-default items-center justify-center rounded-[inherit] bg-[radial-gradient(circle_at_50%_50%,color-mix(in_lch,var(--nou-btn-bg)_92%,transparent)_30%,transparent)]">
