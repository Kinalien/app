...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      tertiaryContainer: Color(0xff9df0fc),
      onTertiaryContainer: Color(0xff004f57),
      ...
      tertiaryFixed: Color(0xff9df0fc),
      onTertiaryFixed: Color(0xff001f23),
      tertiaryFixedDim: Color(0xff81d3df),
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      ...
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xff187883),
      ...
      tertiaryFixed: Color(0xff187883),
  ...
  static ColorScheme darkScheme() {
    return const ColorScheme(
      ...
      tertiary: Color(0xff81d3df),
      onTertiary: Color(0xff00363c),
      tertiaryContainer: Color(0xff004f57),
      onTertiaryContainer: Color(0xff9df0fc),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      ...
      tertiaryContainer: Color(0xff7dcfdb),
